...
class Dog(Game):
    ...
    def get_list_action(self) -> List[Action]:
        ...
        jake_actions = self._generate_jake_swap_actions(player, marbles_in_play)
        actions = []
    ...
    def _generate_jake_swap_actions(self, player: PlayerState, marbles_in_play: list[Marble]) -> List[Action]:
        """
